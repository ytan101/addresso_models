...
if ensemble_learning == 1:
    ...
    # List of models
    models.mlp_classifier(X, Y, X_validation, validation_identifier)
    models.clp_classifier(X, Y, X_validation, validation_identifier)
    models.rf_classifier(X, Y, X_validation, validation_identifier)
    models.ada_classifier(X, Y, X_validation, validation_identifier)
    models.sgd_classifier(X, Y, X_validation, validation_identifier)
    models.gb_classifier(X, Y, X_validation, validation_identifier)
    models.bag_classifier(X, Y, X_validation, validation_identifier)
