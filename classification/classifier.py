...
if ensemble_learning == 1:
    ...
    classifier_models.rf_classifier(X, Y, X_validation, validation_identifier)
    classifier_models.ada_classifier(X, Y, X_validation, validation_identifier)
    classifier_models.sgd_classifier(X, Y, X_validation, validation_identifier)
    classifier_models.gb_classifier(X, Y, X_validation, validation_identifier)
    classifier_models.bag_classifier(X, Y, X_validation, validation_identifier)
    ...
    print(classifier_models.results_dict)
